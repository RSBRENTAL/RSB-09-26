# 10_BLOG_HOME · es — correcciones pendientes

URL: https://rentalscooterbarcelona.com/es/blog/

HTML original sin modificar. SHA-256: `cc4cc59429c3c208ff8fff3b494d9623caad88db2c54adb1d6ec7266c6a1c8b2`. Las líneas se refieren a este index.html.
...
Línea 78 del HTML original:

```html
coordinate=41.390577%2C2.198362
```

Línea 270 del HTML original:
