# 03_SCOOTER · fr — correcciones pendientes

URL: https://rentalscooterbarcelona.com/fr/scooter/

HTML original sin modificar. SHA-256: `ca5bf1e7c7954892ea93eb5acc938d92dd4263faf6a0612fbcc7b917ec9f3d91`. Las líneas se refieren a este index.html.

### U03 · Prioridad 2 · MEDIO

Dos dateModified para la misma WebPage

**Elemento:** WebPage https://rentalscooterbarcelona.com/fr/scooter/#webpage
...
Línea 148 del HTML original:

```html
"dateModified": "2026-07-30"
```

Línea 530 del HTML original:
